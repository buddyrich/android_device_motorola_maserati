...
adb pull /system/lib/hw/gps.maserati.so ../../../vendor/motorola/$DEVICE/proprietary
...
adb pull /system/lib/hw/lights.maserati.so ../../../vendor/motorola/$DEVICE/proprietary
adb pull /system/lib/hw/overlay.omap4.so ../../../vendor/motorola/$DEVICE/proprietary
adb pull /system/lib/hw/sensors.maserati.so ../../../vendor/motorola/$DEVICE/proprietary
...
vendor/motorola/__DEVICE__/proprietary/pppif:/system/bin/pppd-ril \\
vendor/motorola/__DEVICE__/proprietary/pppd-ril-wrapper:/system/bin/pppd-ril \\
...
vendor/motorola/__DEVICE__/proprietary/bashrc:/system/etc/bash/bashrc \\
vendor/motorola/__DEVICE__/proprietary/bashrc:/system/etc/bashrc \\
vendor/motorola/__DEVICE__/proprietary/.bashrc:/system/etc/.bashrc \\
vendor/motorola/__DEVICE__/proprietary/.bashrc:/system/etc/bash/.bashrc \\
...
vendor/motorola/__DEVICE__/proprietary/inadyn.conf:/system/etc/inadyn.conf \\
...
vendor/motorola/__DEVICE__/proprietary/profile:/system/etc/profile \\
vendor/motorola/__DEVICE__/proprietary/profile:/system/etc/bash/profile \\
vendor/motorola/__DEVICE__/proprietary/.profile:/system/etc/.profile \\
vendor/motorola/__DEVICE__/proprietary/.profile:/system/etc/bash/.profile \\
vendor/motorola/__DEVICE__/proprietary/pvplayer.cfg:/system/etc/pvplayer.cfg \\
vendor/motorola/__DEVICE__/proprietary/shells:/system/etc/shells \\
...
vendor/motorola/__DEVICE__/proprietary/connectScript:/system/etc/ppp/chatScripts/connectScript \\
...
# system/lib/hw
PRODUCT_COPY_FILES += \\
vendor/motorola/__DEVICE__/proprietary/gps.maserati.so:/system/lib/hw/gps.maserati.so \\
vendor/motorola/__DEVICE__/proprietary/gralloc.omap4.so:/system/lib/hw/gralloc.omap4.so \\
vendor/motorola/__DEVICE__/proprietary/lights.maserati.so:/system/lib/hw/lights.maserati.so \\
vendor/motorola/__DEVICE__/proprietary/sensors.maserati.so:/system/lib/hw/sensors.maserati.so \\
